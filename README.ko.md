...
Harness는 high 이상의 reasoning effort를 요구합니다. Implement와 Review는 가능할 때 `xhigh`가 필요합니다. `xhigh`를 사용할 수 없으면 Harness는 policy에 따라 fallback 또는 degraded state를 기록합니다.
